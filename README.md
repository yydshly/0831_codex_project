...
| RealHuman 场景产品中心 V2 | [XPADE Face Liquify](research/xpade-face-liquify/README.md) | 在 V1 研究结论之上，以照片、实时视频和扩展产品场景组织真实本地能力；V1 页面及地址继续独立保留 | [在线访问](https://yydshly.github.io/0831_codex_project/demos/realhuman-scenario-showcase/) | [源码](apps/realhuman-scenario-showcase/) | `validated` |
